...
from Hospital.serializers import PatientSerializer, DoctorSerializer, AppointmentSerializer, PaymentSerializer, \
    MedicalCardSerializer, CabinetSerializer, EmploymentPeriodSerializer, \
    ServicePaymentSerializer, ServiceSerializer, DoctorScheduleSerializer
    ...
    def get(self, request, doctor_id):
        ...
        for appointment in appointments:
            result.append({
                ...
                'price': ServicePayment.objects.filter(service=appointment.service).first().amount
            })
...
class PaidPatientsAPIView(APIView):
    def get(self, request):
        ...
        for payment in paid_patients:
            ...
            patient_obj = Payment.objects.get(patient=patient)
